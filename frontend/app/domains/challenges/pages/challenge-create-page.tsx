      ...
      <div className="flex flex-col space-y-4 bg-white rounded-lg shadow-sm p-4 w-full max-w-3xl">
        <div className="flex flex-col space-y-2">
          ...
          <p className="text-gray-800">
            Easy way to create unique CTF-like challenges within seconds. Ask
            the AI assistant questions about the challenge or type the flag to
                ...
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      ...
                      <SelectContent>
                        {Object.values(ChallengeDifficulty).map(
                          (difficulty) => (
